...
export default function ListDosingSetting() {
  ...
  async function ListSetting(page) {
    ...
    await fetch(API_URL + "/list_dosing_setting?page=" + page, requestOptions)
      .then((response) => {
        ...
        <div className="container">
          <div className="d-md-flex">
           ...
           <div className="col-md-4">
              ...
              <Link to="/create/dosing_setting">
                {" "}
                <button className="btn btn-info my-2">
                  <i className="fas fa-plus fa-sm mr-2"></i>Create Schedule
                  Settings
                </button>
              </Link>
            </div>
                  ...
                  <table className="table">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Testing Interval (sec)</th>
                        <th scope="col">Climate value check interval (sec)</th>
                        <th scope="col">Container level check interval (sec)</th>
                        {/* <th scope="col">Draining pots ON time interval (sec)</th>
                        <th scope="col">Draining pots OFF time interval (sec)</th> */}
                      ...
                      {setting_list.map((setting) => {
                        return (
                          <tr>
                            ...
                            <td>
                              <strong>{setting.testing_interval}</strong>
                            </td>
                            <td>
                              <strong>{setting.climate_value_check_interval}</strong>
                            </td>
                            <td>
                              <strong>{setting.container_level_check_interval}</strong>
                            </td>
                            {/* <td>
                              <strong>{setting.draining_pots_on_time_interval}</strong>
                            </td>
                            <td>
                              <strong>{setting.draining_pots_off_time_interval}</strong>
                            </td> */}
                            ...
                            <td>
                              <div className="dropdown text-center mb-3">
                                ...
                                >
                                  <a
                                    onClick={(event) =>
                                      navigate("/edit/dosing_setting/" + setting.id)
                                    }
