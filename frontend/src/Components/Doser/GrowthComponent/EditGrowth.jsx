...
export default function EditGrowth() {
  ...
  async function EditGrowth() {
    const requestOptions = {
      ...
      body: JSON.stringify({ growth_stage_id: params.id }),
    };
    await fetch(API_URL + "/edit_growth_stage", requestOptions)
      .then((response) => {
        return response.json();
      })
      .then((responseData) => {
        setinputValues({
          growth_stage_id: params.id,
        ...
        setgrowth_details(responseData.get_growth_stage);
        responseData.get_growth_stage.forEach((elem) => {
          ...
          <div className="d-md-flex">
            <div className="sidebar">
              <div className="side-wrap ">
                <h3 className="font-weight-bolder mt-2">Edit Growth Stage</h3>
