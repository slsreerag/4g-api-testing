...
export default function FlowAlert() {
  ...
  async function Listreport(page) {
    ...
    await fetch(API_URL + "/get_flow_alert_list?page=" + page, requestOptions)
      .then((response) => {
                                ...
                                return (
                                  <>
                                    <tr key={index}>
                                      ...
                                      <td className="main">{elem.flow_status}</td>
                                      <td className="main">{elem.duration}</td>
                                      <td className="main">{elem.alert_message}</td>
