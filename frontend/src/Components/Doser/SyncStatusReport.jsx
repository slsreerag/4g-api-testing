...
export default function SyncStatusReport() {
  ...
  async function Listreport(page) {
    ...
    await fetch(API_URL + "/get_sync_status_list?page=" + page, requestOptions)
      .then((response) => {
                                ...
                                return (
                                  <>
                                    <tr key={index}>
                                      ...
                                      <td
                                        className={
                                          elem.syncing_status == "1"
                                            ? "text-danger"
                                            : elem.syncing_status == "2"
                                            ? "text-warning"
                                            : elem.syncing_status == "3"
                                            ? "text-success"
                                            : null
                                        }
                                      >
                                        {statusValue(
                                          parseInt(elem.syncing_status)
                                        )}
                                      </td>
                                      {elem.last_updated_time==0 &&
                                      <td className="main">
                                      Not updated yet
                                    </td>
                                      }
