...
export default function EditSystemSetting() {
  ...
  async function EditSetting() {
    const requestOptions = {
      ...
      body: JSON.stringify({ system_setting_id: params.id }),
    };
    await fetch(API_URL + "/edit_system_setting", requestOptions)
      .then((response) => {
        return response.json();
      })
      .then((responseData) => {
        setinputValues({
          ...
          intake_timeout: responseData.intake_timeout,
          draining_timeout: responseData.draining_timeout,
          serial_port_data_timeout: responseData.serial_port_data_timeout,
          no_flow_interupt_time: responseData.no_flow_interupt_time,
          tds_minimum_threshold: responseData.tds_minimum_threshold,
          sample_solution_mixing_time: responseData.sample_solution_mixing_time,
          minimum_dosing_motor_ontime_a:
            responseData.minimum_dosing_motor_on_time_a,
          minimum_dosing_motor_ontime_b:
            responseData.minimum_dosing_motor_on_time_b,
          minimum_dosing_motor_ontime_alkali:
            responseData.minimum_dosing_motor_on_time_alkali,
          minimum_dosing_motor_ontime_acid:
            responseData.minimum_dosing_motor_on_time_acid,
          minimum_dosing_motor_ontime_gp:
            responseData.minimum_dosing_motor_on_time_gp,
          minimum_dosing_quantity: responseData.minimum_dosing_quantity,
          mixer_capacity: responseData.mixer_capacity,
          // flooding_duration:responseData.flooding_duration,
          draining_duration: responseData.draining_duration,
          system_shutdown_waiting_time:
            responseData.system_shutdown_waiting_time,
          tds_dosing_enable: responseData.tds_dosing_enable,
          ph_dosing_enable: responseData.ph_dosing_enable,
          gp_dosing_enable: responseData.gp_dosing_enable,
        });
  ...
  async function sendData() {
    const requestOptions = {
      ...
      body: JSON.stringify({
        ...
        minimum_dosing_motor_on_time_a:
          inputValues.minimum_dosing_motor_ontime_a,
        minimum_dosing_motor_on_time_b:
          inputValues.minimum_dosing_motor_ontime_b,
        minimum_dosing_motor_on_time_acid:
          inputValues.minimum_dosing_motor_ontime_acid,
        minimum_dosing_motor_on_time_alkali:
          inputValues.minimum_dosing_motor_ontime_alkali,
        minimum_dosing_motor_on_time_gp:
          inputValues.minimum_dosing_motor_ontime_gp,
  ...
  function validateform() {
    ...
    if (!inputValues.intake_timeout) {
      ...
      if (isNaN(inputValues.intake_timeout) == true) {
        ...
        if (inputValues.intake_timeout < 0) {
          errors["intake_timeout"] = "Intake timeout can't be negtaive values";
          formValid = false;
    ...
    if (!inputValues.serial_port_data_timeout) {
      ...
      if (isNaN(inputValues.serial_port_data_timeout) == true) {
        errors["serial_port_data_timeout"] =
          "Serial port data timeout should be a number";
        formValid = false;
      } else {
    ...
    if (!inputValues.no_flow_interupt_time) {
      ...
      if (isNaN(inputValues.no_flow_interupt_time) == true) {
        errors["no_flow_interupt_time"] =
          "No flow interupt time should be a number";
        formValid = false;
      } else {
    ...
    if (!inputValues.system_shutdown_waiting_time) {
      errors["system_shutdown_waiting_time"] =
        "System shutdown waiting time required";
      formValid = false;
    } else if (inputValues.system_shutdown_waiting_time) {
      if (isNaN(inputValues.system_shutdown_waiting_time) == true) {
        errors["system_shutdown_waiting_time"] =
          "System shutdown waiting time should be a number";
        formValid = false;
      } else {
        if (inputValues.system_shutdown_waiting_time < 0) {
          errors["system_shutdown_waiting_time"] =
            "System shutdown waiting time can't be negtaive values";
          formValid = false;
          ...
          <div className="d-md-flex">
            <div className="sidebar">
              <div className="side-wrap ">
                <h3 className="font-weight-bolder mt-2">Edit System Setting</h3>
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group col-md-6">
                      ...
                      <input
                        ...
                        value={inputValues.no_flow_interupt_time}
                        onChange={handleInputs}
                      />
                      <div className="errorMsg">
                        {errors.no_flow_interupt_time}
                    ...
                    <div className="col-md-3">
                      <label className="switch">
                        <input
                          ...
                          checked={
                            inputValues.tds_dosing_enable == 1 ? true : false
                          }
                        />
                    ...
                    <div className="col-md-3">
                      <label className="switch">
                        <input
                          ...
                          onClick={handleInputs}
                          checked={
                            inputValues.ph_dosing_enable == 1 ? true : false
                          }
                        />
                        <span class="slider round"></span>
                      </label>
                    ...
                    <div className="col-md-3">
                      <label className="switch">
                        <input
                          ...
                          onClick={handleInputs}
                          checked={
                            inputValues.gp_dosing_enable == 1 ? true : false
                          }
                        />
                        <span class="slider round"></span>
                      </label>
