...
export default function DrainingReport() {
  ...
  async function Listreport(page) {
    ...
    await fetch(API_URL + "/get_draining_list?page=" + page, requestOptions)
      .then((response) => {
                                ...
                                return (
                                  <>
                                    <tr key={index}>
                                      ...
                                      <td className="main">{elem.draining_status}</td>
