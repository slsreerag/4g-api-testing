...
use App\Models\SystemWarnings;
use App\Models\User;
use DB;

class AlertController extends Controller
{
    public function get_alert(Request $request)
    {
        // try {
            ...
            $device_response_arr['event'] = $event;
            $device_response_arr['event_time'] = $event_time;
            $device_response_arr['message'] = $message;
            Alert::create($device_response_arr);
    ...
    public function getAlertsList(Request $request)
    {
        ...
        $pagination_limit = 20;
        $data  = Alert::orderBy('created_at', 'desc');
    ...
    public function get_flow_alert(Request $request)
    {
        // try {
            ...
            $device_response_arr['flow_status'] = $flow_status;
            $device_response_arr['alert_message'] = $alert_message;
            $device_response_arr['date'] = $date;
            $device_response_arr['time'] = $time;
            FlowAlert::create($device_response_arr);
    ...
    public function getFlowAlertsList(Request $request)
    {
        ...
        $page = $request->get('page');
        $pagination_limit = 20;
        $data  = FlowAlert::orderBy('created_at', 'desc');
    ...
    public function get_system_warning(Request $request)
    {
        // try {
            ...
            $reporting_time = $request->get('reporting_time');
            $device_response_arr = [];
            $device_response_arr['machine_id'] = $machine_id;
            $device_response_arr['message'] = $message1[1];
            $device_response_arr['reporting_date'] = $reporting_date;
            $device_response_arr['reporting_time'] = $reporting_time;
            SystemWarnings::create($device_response_arr);
    ...
    public function getSystemWarningList(Request $request)
    {
        ...
        $page = $request->get('page');
        $pagination_limit = 20;
        $data  = SystemWarnings::orderBy('created_at', 'desc');
