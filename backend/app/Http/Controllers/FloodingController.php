...
{
    public function get_flooding_data(Request $request)
    {
        // try {
            ...
            $flood_status = $request->get('flood_status');
    ...
    public function getFloodReport(Request $request)
    {
        ...
        $pagination_limit = 20;
        $data  = FloodingReport::orderBy('created_at', 'desc');
