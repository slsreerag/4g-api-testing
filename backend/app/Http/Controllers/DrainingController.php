...
class DrainingController extends Controller
{
    public function get_draining_data(Request $request)
    {
        // try {
            ...
            $draining_status = $request->get('draining_status');
            ...
            $device_response_arr['draining_status'] = $draining_status;
            $device_response_arr['duration'] = $duration;
            $device_response_arr['date'] = $date;
            $device_response_arr['time'] = $time;
            DrainingReport::create($device_response_arr);
    ...
    public function getDrainingReport(Request $request)
    {
        ...
        $pagination_limit = 20;
        $data  = DrainingReport::orderBy('created_at', 'desc');
